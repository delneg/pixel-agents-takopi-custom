...
function App() {
  ...
  const { agents, selectedAgent, agentTools, agentStatuses, subagentTools, subagentCharacters, layoutReady, loadedAssets, lastAnswers } = useExtensionMessages(getOfficeState, editor.setLastSavedLayout, isEditDirty)
